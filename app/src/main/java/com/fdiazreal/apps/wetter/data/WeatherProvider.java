...
public class WeatherProvider extends ContentProvider {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match){
            ...
            default:
                throw new UnsupportedOperationException("Unknown uri used to delete: " + uri);
        }
    ...
    public int update(
        ...
        switch (match){
            case WEATHER: {
               updatedRows = writableDatabase.update(WeatherContract.WeatherEntry.TABLE_NAME, values, selection, selectionArgs);
                break;
            }
            case  LOCATION: {
                updatedRows = writableDatabase.update(WeatherContract.LocationEntry.TABLE_NAME, values, selection, selectionArgs);
                break;
            }
            default:
                throw new UnsupportedOperationException("Unknown uri used to delete: " + uri);
